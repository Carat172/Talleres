<?php 
    ...
    if(isset($_GET['id'])){
        ...
        $sql = "SELECT * FROM canto WHERE matricula = $id";
        ...
        if(isset($_POST['update'])){
            ...
            $sql = "UPDATE canto SET matricula = '$matricula', nombre = '$nombre', correo = '$correo' WHERE matricula = $id";

            mysqli_query($conn,$sql);



            header('location: admin-canto.php');
        }
    }
?>
<!DOCTYPE html>
